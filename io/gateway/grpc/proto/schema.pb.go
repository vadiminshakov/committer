...
func (x *Vote) GetIsAccepted() bool {
	if x != nil {
		return x.IsAccepted
	}
	return false
...
func (x *PrecommitRequest) GetVotes() []*Vote {
	if x != nil {
		return x.Votes
	}
	return nil
...
var file_schema_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x3a, 0x0a, 0x04,
	0x56, 0x6f, 0x74, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x6e, 0x6f, 0x64, 0x65, 0x12, 0x1e, 0x0a, 0x0a, 0x69, 0x73, 0x41, 0x63,
	0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x73,
	0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x65, 0x64, 0x22, 0x4c, 0x0a, 0x10, 0x50, 0x72, 0x65, 0x63,
	...
	0x65, 0x78, 0x12, 0x22, 0x0a, 0x05, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x0c, 0x2e, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e, 0x56, 0x6f, 0x74, 0x65, 0x52,
	0x05, 0x76, 0x6f, 0x74, 0x65, 0x73, 0x22, 0x45, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x69, 0x74,
...
var file_schema_proto_depIdxs = []int32{
	...
	4,  // 2: schema.PrecommitRequest.votes:type_name -> schema.Vote
	2,  // 3: schema.Commit.Propose:input_type -> schema.ProposeRequest
	5,  // 4: schema.Commit.Precommit:input_type -> schema.PrecommitRequest
	6,  // 5: schema.Commit.Commit:input_type -> schema.CommitRequest
	7,  // 6: schema.Commit.Put:input_type -> schema.Entry
	8,  // 7: schema.Commit.Get:input_type -> schema.Msg
	11, // 8: schema.Commit.NodeInfo:input_type -> google.protobuf.Empty
	3,  // 9: schema.Commit.Propose:output_type -> schema.Response
	3,  // 10: schema.Commit.Precommit:output_type -> schema.Response
	3,  // 11: schema.Commit.Commit:output_type -> schema.Response
	3,  // 12: schema.Commit.Put:output_type -> schema.Response
	9,  // 13: schema.Commit.Get:output_type -> schema.Value
	10, // 14: schema.Commit.NodeInfo:output_type -> schema.Info
