...
//
//	mockgen -destination=../../../../mocks/mock_cohort.go -package=mocks . Cohort
//
...
func (m *MockCohort) Abort(ctx context.Context, req *dto.AbortRequest) (*dto.CohortResponse, error) {
	m.ctrl.T.Helper()
...
func (mr *MockCohortMockRecorder) Abort(ctx, req any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Abort", reflect.TypeOf((*MockCohort)(nil).Abort), ctx, req)
}
